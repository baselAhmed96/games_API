...
return <>
    {gameDetails.length !== 0 ? <div className="container">
        <div className="row">
            <div className="col-md-5 col-lg-4">
                <div className="game-detail-cover">
                    ...
                    <div className='d-flex justify-content-between p-2'>
                        ...
                        <a className='w-75 ' target={'_blank'} href={gameDetails.game_url} rel="noreferrer"><button
                                className='btn text-white fw-bolder w-100'>PLAY NOW <i
                                    className="fa-solid fa-right-to-bracket"></i></button></a>
                    </div>
                </div>
            </div>
            <div className="col-md-7 col-lg-8 text-white-50">
                ...
                <>
                    ...
                    <ul className='p-0 text-white-50'>
                        <li><span className='fw-bold'>Graphics :
                            </span>{gameDetails.minimum_system_requirements.graphics}</li>
                        <li><span className='fw-bold'>Memory : </span>{gameDetails.minimum_system_requirements.memory}
                        </li>
                        <li><span className='fw-bold'>Os : </span>{gameDetails.minimum_system_requirements.os}</li>
                        <li><span className='fw-bold'>Processor :
                            </span>{gameDetails.minimum_system_requirements.processor}</li>
                        <li><span className='fw-bold'>Storage : </span>{gameDetails.minimum_system_requirements.storage}
                        </li>
                    </ul>
                </>
                : null}
                ...
                <>
                    ...
                    <Swiper effect={"creative"} spaceBetween={10} slidesPerView={"auto"} centeredSlides={true}
                        grabCursor={true} loop={true} loopFillGroupWithBlank={true} autoplay={{
            delay: 2000,
          ...
          }} modules={[Autoplay, EffectCreative, Keyboard]} className="mySwiper">
                        {gameDetails.screenshots.map((img, index) => <SwiperSlide key={index}><img className='img-fluid'
                                src={img.image} alt="" /></SwiperSlide>)}
                    </Swiper>
                </> : null}
                ...
                <div className="container-fluid game-add-info">
                    <div className="row">
                        ...
                        <div className="col-6 col-md-6 col-lg-4 ps-0">
                            ...
                            <p>{gameDetails.platform === 'Windows' ? <><i
                                        className="fa-brands fa-windows text-secondary"></i><span> Windows</span></> :
                                <><i className="fa-brands fa-chrome text-secondary"></i><span> Web Browser</span></>}
                            </p>
                        </div>
                    </div>
                </div>
